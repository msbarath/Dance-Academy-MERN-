                ...
                <div className="contact-grid">
                    ...
                    <div className="contact-form-box">
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            ...
                            <input type="text" name="name" placeholder="Enter your name" value={form.name} onChange={handleChange} onBlur={handleBlur} className={errors.name ? "input-error" : ""} />
                            {errors.name && <span className="field-error" role="alert">{errors.name}</span>}

                            <label>Email Address</label>
                            <input type="email" name="email" placeholder="Enter your email" value={form.email} onChange={handleChange} onBlur={handleBlur} className={errors.email ? "input-error" : ""} />
                            {errors.email && <span className="field-error" role="alert">{errors.email}</span>}

                            <label>Message</label>
                            <textarea name="message" placeholder="Enter your message (10–500 characters)" value={form.message} onChange={handleChange} onBlur={handleBlur} className={errors.message ? "input-error" : ""} />
